    ...
    <div id="app">
        ...
        <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                <!-- Left navbar links -->
<seccion class="perfil">          
 <div class="btn-group">
  <button  style="right:-900px; width:auto; " type="button" class="btn btn-secondary dropdown-toggle"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
   Ejemplo
  </button>
  <div class="dropdown-menu dropdown-menu-right" style="right:-900px; width:auto;">
    <button class="dropdown-item" style="background-color:#4CAAD4" type="button">Editar</button>
    <button class="dropdown-item" style="background-color:#4CAAD4" type="button"  href="{{ route('logout') }}"onclick="event.preventDefault(); document.getElementById('logout-form').submit();">cerrar sesion</button>
  </div>
</div>
</seccion>
