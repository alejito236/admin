                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(url('ejemplo')); ?>"
                                    class="<?php echo e(Request::path() === 'ejemplo' ? 'nav-link active' : 'nav-link'); ?>">
...
</html><?php /**PATH C:\laragon\www\admin\resources\views/layouts/princi.blade.php ENDPATH**/ ?>