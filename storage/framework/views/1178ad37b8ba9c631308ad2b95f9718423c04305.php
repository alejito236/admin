...
<?php endif; ?>
            <form action="<?php echo e(route('usuarios.update', $user->id)); ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" value='<?php echo e($user->name); ?>' placeholder="Escribe tu nombre" required>
                </div>
                <div class="form-group">
                    <label for="email">Email</label>
                    <input type="email" class="form-control" name="email" value='<?php echo e($user->email); ?>' placeholder="Escribe tu correo" required>
                </div>
