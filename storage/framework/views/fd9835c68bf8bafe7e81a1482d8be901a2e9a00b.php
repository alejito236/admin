...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" placeholder="Ingrese Correo Electrónico" required autocomplete="email" autofocus>
...
$message = $__bag->first($__errorArgs[0]); ?>
    <span class="invalid-feedback" role="alert">
        <strong style="color:#bc5e11" ><?php echo e($message); ?></strong>
    </span>
<?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
unset($__errorArgs, $__bag); ?>" name="password" placeholder="Ingrese Contraseña" required autocomplete="current-password">
...
unset($__errorArgs, $__bag); ?>
          ...
          <?php if(Route::has('password.request')): ?>
            <a href="#"><?php echo e(__('Olvidaste tu contraseña')); ?></a>
            <?php endif; ?>
          </div>
          <div class="field">
            <input type="submit" value=" <?php echo e(__('Iniciar sesion')); ?>">
          </div>
